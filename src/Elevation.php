...
class Elevation extends Service
{
     ...
     * @var string
     */
    public const API_PATH = '/maps/api/elevation/json';

    /**
     * Elevation
     *
     * @param \yidas\googleMaps\Client $client
     * @param array|string $locations - can be a string in the format of 'lat,lon' or 'lat1,lon1|lat2,lon2|...'
     ...
     * @return array Result
     */
    public static function elevation(Client $client, $locations, array $params = [])
    {
